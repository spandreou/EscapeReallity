...
No Docker, Node, Python, .NET, Go, or Rust marker file was found during the local scan. If this project is deployed later, update this file with the server path, compose project name, container names, ports, and health checks.
...
docker compose ls
find /home/spandreou/projects /opt -maxdepth 3 -type d -iname '*escape*' 2>/dev/null
```
